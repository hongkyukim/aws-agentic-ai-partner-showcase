# Lab 03 — LangChain orchestration

**Goal:** translate the local orchestration seam into an agent/workflow implementation without weakening the policy boundary.

## Exercise

Create a Python or TypeScript spike outside the default local path with these conceptual boundaries:
...
Use LangChain's current official documentation for exact APIs and package setup. Do not copy a version-sensitive snippet into this repository without pinning and testing it.
